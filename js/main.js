$(document).ready(function () {
    ...
    function addImage() {
        ...
        switch(num) {
            ...
            description.innerHTML = 'Нехай життя буде ще більш сонячним та радісним разом з чізбургером від<br> Family Burger! Фірмове поєднання приготованої на грилі соковитої курячої котлети із злегка розплавленим бутербродним сиром, свіжа пекінська капуста, соковиті помідори і ніжний пікантний соус. Яскраве поєднання смаку та прянощів!';
            break;
            case 3:
