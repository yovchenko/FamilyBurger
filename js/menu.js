...
function addImage() {
    ...
    switch (num) {
        ...
        case 13:
            ...
            description.innerHTML = '<b>Піца Капоне</b><br>Склад: cоус томатний, шинка, сир, печериці, болгарський перець, вершковий соус, нотки чарівності.';
            break;
        case 14:
            price.innerHTML = '68,50 грн.';
            description.innerHTML = '<b>Піца Кантрі</b><br>Склад: cоус, куряче філе, сир Голандський, сир Фета, помідори, кукурудза, перець чілі, міцний дух.';
            break;
        case 15:
            price.innerHTML = '85 грн';
            description.innerHTML = '<b>Піца Фамілі</b><br>Склад: cоус, сир, Куряче філе,печериці, помідори, болгарський перець, кукурудза, ананас, родинне тепло.';
            break;
        case 16:
            price.innerHTML = '67 грн.';
            description.innerHTML = '<b>Піца Салямі</b><br>Склад: cоус томатний, мисливські ковбаски, салямі, сир, вершковий соус, смак перемоги.';
            break;
        case 17:
            price.innerHTML = '35 грн.';
